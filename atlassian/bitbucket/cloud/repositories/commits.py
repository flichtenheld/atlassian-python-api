...
class Commits(BitbucketCloudBase):
    ...
    def each(self, top=None, q=None, sort=None):
        """
        Returns the list of commits in this repository.
    ...
    def get(self, hash):
        """
        Returns the commit with the requested commit id in this repository.

        :param hash: str: The requested commit id
        ...
        return self.__get_object(
            super(Commits, self).get(self.url_joiner(self.get_link("commit"), hash), absolute=True)
        )
...
class Commit(BitbucketCloudBase):
    ...
    def parents(self):
        """
        Returns a generator object of parent commits.
        """
    ...
    def builds(self):
        """Returns the Build objects for the commit."""
    ...
    def get_build(self, key):
        """
        Returns a specific build for the commit.
